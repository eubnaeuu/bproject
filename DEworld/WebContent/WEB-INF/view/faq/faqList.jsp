...
<link href="/DEworld/html/notice/css/commonMainpage.css" rel="stylesheet">
...
<script type="text/javascript" src="/DEworld/js/faq/faqList.js"></script>
<link href="/DEworld/css/noticeList.css" rel="stylesheet"> 
		...
		<div class="container h-100">
			<div class="row h-100 align-items-center">
				<div class="col-lg-12">
					...
					<br>
					<button type="button" class="btn btn-primary btn-lg raised" onclick="goMyHompi()">내
						미니홈피</button>
					<br>
					<br>
	...
	<div class="container-fluid text-center">
		<div class="row content">
			...
			<div class="col-sm-8 text-left" style="margin-top: 100px;">
				<h1>FAQ</h1>
				<hr>
				<button id="deleteNotice" onclick="deleteNotice()"
					disabled="disabled">삭제하기</button>
				<button id="insertNotice" onclick="insertNewNotice()">작성하기</button>
				<hr>
				<form id="fm" style="margin-bottom:30px">
					<table id="FaqBoard" style="width: 60%;">
						<thead>
							<tr>
