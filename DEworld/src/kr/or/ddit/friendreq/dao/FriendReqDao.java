...
public interface FriendReqDao {
	 ...
	 */
	public boolean checkFriendReq(SqlMapClient smc, String FriendReqId)
			throws SQLException;
	
	/**
	 * FriendReqVO 객체에 담겨진 자료를 DB에 insert하는 메서드
	 * @param smc SqlMapClient 객체
	...
	/**
	 * DB의 myFriendReq테이블의 전체 레코드를 가져와서 List에 담아 반환하는 메서드
	 * @param smc SqlMapClient 객체
	 * @return 회원정보를 담고있는 List객체
	 * @throws SQLException JDBC관련 예외객체
	 */
	
	public List<FriendReqVO> getAllFriendReqList(SqlMapClient smc)
	 					throws SQLException;
	 ...
	 */
	public int updateFriendReq(SqlMapClient smc, FriendReqVO fv)
						throws SQLException;
	/**
	 ...
	 * @throws SQLException JDBC관련 예외 객체
	 */
	public List<FriendReqVO> getSearchFriendReq(SqlMapClient smc, FriendReqVO fv) 
						throws SQLException;
}
