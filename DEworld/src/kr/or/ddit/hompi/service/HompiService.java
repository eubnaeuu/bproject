 ...
 * 회원정보 처리를 수행하는 서비스 
 */
public interface HompiService {
	
	/**
	 * 회원등록하는 메서드
	 * @param pv DB에 insert할 자료가 저장된 HompiVO객체
	 ...
	 */
	public boolean checkHompi(String postNo);
	 ...
	 * @return 작업성공 : 1, 작업실패: 0 
	 */
	public int deleteHompi(String postNo);
	
	
	/**
	 * HompiVO 객체에 담긴 자료를 이용하여 회원을 검색하는 메서드
	 * @param pv 검색할 자료가 들어있는 HompiVO 객체
