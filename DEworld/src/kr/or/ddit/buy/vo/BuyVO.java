...
public class BuyVO {
	...
	public String getLitemGu() {
		return litemGu;
	}
	public void setLitemGu(String litemGu) {
		this.litemGu = litemGu;
	}
	...
	public String getMusicCost() {
		return musicCost;
	}
	public void setMusicCost(String musicCost) {
